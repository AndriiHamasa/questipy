...
urlpatterns = [
    ...
    path("projects/<int:project_pk>/tasks/update/<int:pk>/", ProjectTaskUpdateView.as_view(), name="project-task-update"),
    path("projects/<int:project_pk>/tasks/<int:pk>/", ProjectTaskDetailView.as_view(), name="project-task-detail"),
    path("projects/<int:project_pk>/tasks/<int:pk>/delete", ProjectTaskDeleteView.as_view(), name="project-task-delete"),
